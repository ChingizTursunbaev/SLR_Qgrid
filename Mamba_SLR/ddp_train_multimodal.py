...
def parse_args():
    ...
    ap.add_argument("--meta_dir", required=True)       # will be passed to dataset as meta_dir_path
    ap.add_argument("--gloss_dict", required=True)     # will be passed to dataset as gloss_dict_path
